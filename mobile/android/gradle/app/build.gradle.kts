...
android {
    namespace = "dev.waku.mobile"
    compileSdk = 34

    defaultConfig {
        applicationId = "dev.waku.mobile"
        ...
        manifestPlaceholders["nativeLibraryName"] = "waku_mobile"
    }
    ...
    packaging {
        ...
        jniLibs {
            keepDebugSymbols += listOf(
                "*/arm64-v8a/libwaku_mobile.so",
                "*/armeabi-v7a/libwaku_mobile.so",
